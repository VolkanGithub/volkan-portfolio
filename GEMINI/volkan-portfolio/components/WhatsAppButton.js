...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-gradient-to-r from-purple-700 to-pink-600 text-white px-5 py-3 rounded-full shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/50 transition-all overflow-hidden font-medium"
