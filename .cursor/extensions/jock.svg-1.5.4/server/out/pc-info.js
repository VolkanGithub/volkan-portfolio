...
exports.signatureFromPathCommand = exports.pathCommandFromChar = exports.isCommandChar = exports.PathDataSignature = exports.DefinedCommands = exports.readNumber = exports.PathDataTokenType = void 0;
...
function pathCommandFromChar(c) {
    for (let pc of exports.DefinedCommands) {
        if (pc.label === c) {
            return pc;
        }
    }
...
exports.pathCommandFromChar = pathCommandFromChar;
function signatureFromPathCommand(pc) {
    let si = {
        label: pc.label + ' ',
        parameters: [],
...
exports.signatureFromPathCommand = signatureFromPathCommand;
//# sourceMappingURL=pc-info.js.map