...
exports.ENodeBuilder = exports.execAll = void 0;
const tag_builder_1 = require("./tag-builder");
var ENodeKind;
(function (ENodeKind) {
    ENodeKind[ENodeKind["root"] = 0] = "root";
    ENodeKind[ENodeKind["element"] = 1] = "element";
})(ENodeKind || (ENodeKind = {}));
// 参考标准：
...
function replace_number(str, current, count) {
...
class ENodeBuilder {
    constructor(svginfo) {
         ...
         * 默认顶层标签
         */
        this.defaultTagName = "svg";
        /** 使用标签树关系过滤下层可用标签 */
        this.defaultTagUseTree = false;
        /**
         * 是否生成 Snippet 变量参数
         */
        this.useSnippet = true;
        this.partStartIndex = 0;
        this.partStartOffset = 0;
        this.indent = '  ';
        this.snippetIndex = 0;
    ...
    getDefaultTagForParent(parentTag) {
        if (parentTag) {
    ...
    newSnippetAttribute(builder, value) {
        this.snippetIndex++;
    ...
    buildNode(outputs, node, indentLevel = 0, contextNumber = 1, contextCount = 1, inline = false) {
        let startNumber = 1;
        let endNumber = 1;
    ...
    toCode() {
        ...
        this.snippetOutputIndex = 0;
        this.lastSnippetValued = false;
        const builder = new tag_builder_1.TagBuilder();
...
exports.ENodeBuilder = ENodeBuilder;
//# sourceMappingURL=emmet-builder.js.map